  ...
  return (
    <div className="w-full min-h-screen gap-5 flex flex-col text-start justify-center pl-[5%] pb-[15%] z-10">
      <div className="text-start z-10">
        <h1 className="text-white font-extrabold z-10 text-7xl font-fugaz_one text-shadow-md">
          AUTOMOTORES
        </h1>
      ...
      <div className="flex flex-row items-center mr-auto gap-6 z-10">
        <button className=" bg-gray-image py-[5px] w-32 rounded-2xl backdrop-blur-lg shadow-lg font-semibold">
          CONSULTA
        </button>
        <button className="py-[5px] w-32 rounded-2xl backdrop-blur-lg shadow-lg font-semibold bg-azul-image">
          USADOS
        </button>
      </div>
    </div>
